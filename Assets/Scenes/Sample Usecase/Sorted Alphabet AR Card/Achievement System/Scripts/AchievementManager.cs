...
public class AchievementManager : MonoBehaviour
{
    ...
    public void OpenCloseAchievement()
    {
        ...
        if (FindObjectOfType<CardDetectionManager>() != null)
        {
            CardDetectionManager.Instance.OpenCloseUI();
        }
    }
    ...
    {
        if (achievements.ContainsKey(title) == false)
        {
            Debug.Log($"{title} achievement key not found");
            return;
        }
